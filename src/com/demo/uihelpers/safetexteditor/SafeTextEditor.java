 ...
 */
package com.demo.uihelpers.safetexteditor;
...
public abstract class SafeTextEditor {
    ...
    public abstract void insert(String text, int position);
    ...
    public abstract void setInitialInputMode(String characterSubset);
