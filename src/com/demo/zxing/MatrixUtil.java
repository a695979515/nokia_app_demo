...
final class MatrixUtil {
    ...
    static void buildMatrix(BitArray dataBits, ErrorCorrectionLevel ecLevel, Version version, int maskPattern, ByteMatrix matrix) throws RuntimeException {
        clearMatrix(matrix);
    ...
    static void embedTypeInfo(ErrorCorrectionLevel ecLevel, int maskPattern, ByteMatrix matrix) throws RuntimeException {
    ...
    private static void embedHorizontalSeparationPattern(int xStart, int yStart, ByteMatrix matrix) throws RuntimeException {
        for(int x = 0; x < 8; ++x) {
    ...
    private static void embedVerticalSeparationPattern(int xStart, int yStart, ByteMatrix matrix) throws RuntimeException {
        for(int y = 0; y < 7; ++y) {
